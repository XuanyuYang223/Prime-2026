...
def main():
    ...
    if checkpoint.get("data_mode") == "character":
        ...
        _, glyph, positions = build_character_sequence_condition(tuple(character_text.split()), args.motion, spec)
    elif args.sentence:
    ...
    generated = euler_sample(model, glyph, positions, args.ode_steps, args.seed)
